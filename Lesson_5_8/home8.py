...
explode = (0, 0, 0, 0,0.1)
plt.pie(sizes, labels=labels, colors=colors, explode=explode, startangle=100,counterclock=False)

# График 10
plt.figure()
plt.pie(sizes, labels=labels, colors=colors, startangle=100,counterclock=False)
