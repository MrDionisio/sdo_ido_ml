...
# задание 1: использование мультииндексных ключей
index = [
    ('city_1',2010),
    ('city_1',2020),
    ('city_2',2010),
...
print('df1')
print(pop_df.loc[['city_1'],'something'])  # возвращает series
print(pop_df.loc[['city_1'],['something']])  # возвращает df

print('df2')
print(pop_df.loc[['city_1', 'city_3'],['total', 'something']])

print('df3')
print(pop_df.loc[['city_1', 'city_3'],'something'])  # series
print(pop_df.loc[['city_1', 'city_3'],['something']])  # df
